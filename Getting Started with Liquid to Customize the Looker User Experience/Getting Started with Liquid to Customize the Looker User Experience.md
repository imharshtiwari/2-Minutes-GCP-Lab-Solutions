# Getting Started with Liquid to Customize the Looker User Experience || [GSP933](https://www.cloudskillsboost.google/games/6397/labs/40304) ||
...
###  **Open `user.view` and replace with this code**  
...
### 🚀 **Open `order_Items.view` and replace with this code** 
