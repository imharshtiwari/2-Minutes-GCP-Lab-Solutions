...
echo "${CYAN_TEXT}${BOLD_TEXT}       Krlo Subscribe paise nhi lag jayenge (in emotional)  Follow Video For Other Tasks      ${RESET_FORMAT_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=============================================================================================${RESET_FORMAT_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@sparkwavedev${RESET_FORMAT_FORMAT}"
echo "
