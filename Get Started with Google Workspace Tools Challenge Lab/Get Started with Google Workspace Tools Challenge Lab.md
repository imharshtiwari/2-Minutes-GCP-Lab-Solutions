...
3. Give this signature `sparkwave` name, then click `Create`.

4. In the Signature defaults section, use the dropdown menu under `For New Emails Use` and select `sparkwave`.
...
3. For `App name`, type `sparkwave` to name your app.
