...
echo "${BLUE}${BOLD}                   SPARKWAVE Cloud Tutorials                     ${RESET}"
echo "${BLUE}${BOLD}====================================================================${RESET}"
echo
...
echo "${GREEN}${BOLD}====================================================================${RESET}"
echo
echo "${BLUE}${BOLD}Thank you for using SPARKWAVE Cloud Tutorials!${RESET}"
echo
echo "${YELLOW}${BOLD}For more cloud tutorials and labs, visit:${RESET}"
echo "${CYAN}https://www.youtube.com/@sparkwave.01/videos${RESET}"
echo
