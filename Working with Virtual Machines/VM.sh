...
sudo curl https://raw.githubusercontent.com/imharshtiwari/2-Minutes-GCP-Lab-Solutions/main/Working%20with%20Virtual%20Machines/backup.sh --output backup.sh
