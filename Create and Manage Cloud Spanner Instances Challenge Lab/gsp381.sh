...
# Completion message
echo "${BG_RED}${BOLD}Lab Completed Successfully - Sparkwave Dev Cloud Tutorials${RESET}"
echo "${BLUE}For more tutorials visit: https://www.youtube.com/@sparkwavedev${RESET}"
