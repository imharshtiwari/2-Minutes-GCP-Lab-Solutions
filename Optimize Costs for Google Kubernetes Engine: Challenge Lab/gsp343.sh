...
echo -e "${BLUE_TEXT}         ✨✨✨  GOOGLE CLOUD LAB | SPARKWAVE DEV  ✨✨✨            ${RESET_FORMAT}"
echo -e "${BLUE_TEXT}==================================================================${RESET_FORMAT}"
echo ""
...
echo -e "${RED_TEXT}              ✨✨  Subscribe to SPARKWAVE DEV  ✨✨                ${RESET_FORMAT}"
echo -e "${RED_TEXT}==================================================================${RESET_FORMAT}"
echo ""
echo -e "${BLUE_TEXT}  Thank you for learning with Sparkwave Dev ! ✨✨ ${RESET_FORMAT}"
echo -e "${RED_TEXT}  Subscribe for more Google Cloud Labs:${RESET_FORMAT}"
echo -e "${BLUE_TEXT}  👉  https://www.youtube.com/@sparkwavedev${RESET_FORMAT}"
echo ""
